...
_EN = {
    ...
    "pg.wheel_arrows": "Arrows run from the planet acting to the one it acts on; two arrowheads mean mutual.",
...
_TA = {
    ...
    "pg.wheel_arrows": "அம்புக்குறிகள் செயல்படும் கிரகத்திலிருந்து அதனால் பாதிக்கப்படுவதை நோக்கிச் செல்கின்றன; இரு முனை அம்பு என்றால் பரஸ்பரம்.",
